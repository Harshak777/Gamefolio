  ...
  function Example() {
    ...
    return (
      <>
        ...
        <div class="m-btn" onClick={() => setLgShow(true)}><span>Join Now</span></div>
                ...
                <div class="tb">
                    <div class="td">
                        <div class="tb" id="p-tabs-m">
                            <div class="td  "><span>Registered:2000</span></div>
                            <div class="td "><span>Team Size:4-5</span></div>
                            <div class="td "><div id="title">Start Date</div><span>{data.start}</span></div>
                            <div class="td "><div id="title">End Date</div><span> {data.end}</span></div>
                            <div class="td "><div id="title">Game day</div><span> Apr 07 12:00 PM </span></div>
                        </div>
                    </div>
