...
const getTeamID = async () => {
  ...
  await axios.post(`${process.env.NEXT_PUBLIC_API}/getTeamId`, temp1)
              .then(res => {
                  if(res.data!=null)
                  setTid(res.data.tid);
                  setPid(res.data.pid);
...
useEffect(() => {
  ...
  const fetchTeamData = async () => {
    ...
    await axios.post(`${process.env.NEXT_PUBLIC_API}/getTeamDetails`, temp)
                .then(res => {
  ...
  const submit  = async (e) => {
    ...
    console.log(form);
    await axios.post(`${process.env.NEXT_PUBLIC_API}/addparticipant`, form)
                .then(res => {
                    console.log(res);
                    alert(res.data.ref);
                    setLgShow(false);
  ...
  const submitWR = async (e) => {
    ...
    console.log(form);
    await axios.post(`${process.env.NEXT_PUBLIC_API}/addparticipantwr`, form)
                .then(res => {
                    console.log(res);
...
async function leaveTeamHelper() {
  ...
  await axios.post(`${process.env.NEXT_PUBLIC_API}/leave-team`, form)
              .then(res => {
                  console.log(res);
